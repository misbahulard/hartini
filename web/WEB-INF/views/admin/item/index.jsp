...
<div class="ui bottom attached segment pushable">
    ...
    <div class="pusher">
        <div class="ui basic segment">
            ...
            <h3 class="ui header">Manage Item</h3>

            <a href="/admin/item/create" class="ui labeled icon primary button">
                ...
                <c:forEach items="${itemList}" var="item">
                    <tr>
                        ...
                        <td>Rp.<fmt:formatNumber currencyCode="id_ID" value="${item.price}"/></td>
                            <%--<td><% kursIndonesia.format(1); %>${item.price}</td>--%>
                        <td>${item.itemCategoryByCategoryId.name}</td>
                        <td><img class="ui tiny image"
                                 src="${pageContext.request.contextPath}/assets/img/item/${item.image}"
                                 alt="${item.name}"></td>
                        <td class="collapsing">
                            ...
                            <a class="ui vertical animated button negative" tabindex="0"
                               href="/admin/item/delete/${item.id}">
